	...
	<form action="#" method="POST">
		<?php
			...
			if(isset($_POST['nombre'])){
				...
				if(isset($_POST['nivel'])){ // si existe la variable de post, entonces la variable de post sera nivel
					$nivel = $_POST['nivel'];
				}else{
					$nivel = "";
				}
				...
				if(isset($_POST['lenguajes'])){//si existes una variable en post entonces lo pones sino vacio
				...
				if($lenguajes == "" || count($lenguajes) < 2){//validacion de los cheackbox, si es vacio o menos de 2, manda mensaje
		...
		<p>
			...
			<input type="checkbox" name="lenguajes[]" value="php" <?php if(in_array("php", $lenguajes)) echo "checked"; ?>> PHP <br><!--in_array para validar los lenguajes-->
